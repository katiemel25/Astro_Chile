...
def total(line_number):
	...
	while count_lines < line_number:
		max_index = np.argmax(lande_g1)
		lande_g1 = np.delete(lande_g1, [max_index])
		red1 = np.delete(red1, [max_index])
		blue1 = np.delete(blue1, [max_index])
		weight1 = np.delete(weight1, [max_index])
		count_lines += 1
...
p_std_hist = np.savetxt("/home/katie/files/2000_5_std_data_hist.txt", std_hist_array)
p_mad = np.savetxt("/home/katie/files/2000_5_mad_data.txt", mad_array)
p_std_MCavg = np.savetxt("/home/katie/files/2000_5_std_data_MCavg.txt", std_MCavg_array)
p_std_RV = np.savetxt("/home/katie/files/2000_5_RV_data.txt", mean_array)
p_amp = np.savetxt("/home/katie/files/2000_5_amp_data.txt", amp_array)
p_time = np.savetxt("/home/katie/files/2000_5_time_data.txt", time_per_section)
